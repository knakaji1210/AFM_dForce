...
def force_ts(option_mask,z,v,t,f0,k,Q,Rt,a0,E,E_sample,E2,H,H2,angle,sahe,bonded,nu,
        m,D,F0,zc,eta,sigmas,sigmat,landadeb,epsilonr,alpha,nc,magnetic_m_tip, magnetic_m_sample,magnetic_B0_sample,magnetic_k_sample,epsilon_lj,sigma_lj,V1,V2,V3,V4,):
    
    f = np.zeros(len(z))
    for ii in range(len(z)):
        f[ii] = forces.sumatory(option_mask,z[ii],v[ii],t[ii],f0,k,Q,Rt,a0,E,E_sample,E2,H,H2,angle,sahe,bonded,nu,m,D,F0,
                                zc,eta,sigmas,sigmat,landadeb,epsilonr,alpha,nc,
                                magnetic_m_tip, magnetic_m_sample,magnetic_B0_sample,magnetic_k_sample,epsilon_lj,sigma_lj,V1,V2,V3,V4) - forces.driven(F0,f0,t[ii])
